...
def user_place_ship(self):
    ...
    it verfies all the data input by user is correct and 
    if not then sends error message
...
def ask_user_start():
    """
    This function is written to give the user control,
    over when to start the game.
...
def end_game():
    """
    This function is used if the user decides to stop playing,
